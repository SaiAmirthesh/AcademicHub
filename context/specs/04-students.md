...
- `image`: URL to Cloudinary profile avatar.
...
- **`PUT /api/students/:id`**: Updates student profile details (such as avatar or contact details). Restricted to **Admin** or the **Student** themselves.
...
- **Student Directory (`src/pages/students/list.tsx`)**: Table displaying Avatar, Name, Email, Department, and Enrolled Classes count. Visible to Admins and Teachers.
